...
__all__ = [ 'OLE_XPOS_PIXELS', 'IPictureDisp', 'LoadPictureConstants',
           'OLE_YPOS_CONTAINER', 'OLE_YPOS_PIXELS',
           'OLE_OPTEXCLUSIVE', 'FONTNAME', 'IPicture',
           'OLE_XPOS_HIMETRIC', 'OLE_ENABLEDEFAULTBOOL', 'FontEvents',
           'OLE_HANDLE', 'OLE_XSIZE_CONTAINER', 'VgaColor',
           'OLE_XPOS_CONTAINER', 'FONTBOLD', 'StdFont', 'Default',
           'FONTSIZE', 'IFontDisp', 'Checked', 'Picture', 'Color',
           'Font', 'Monochrome', 'OLE_CANCELBOOL', 'OLE_TRISTATE',
           'OLE_YSIZE_CONTAINER', 'IFont', 'IFontEventsDisp',
           'OLE_XSIZE_PIXELS', 'FONTITALIC', 'OLE_COLOR', 'Gray',
           'FONTSTRIKETHROUGH', 'Unchecked', 'OLE_YSIZE_HIMETRIC',
           'OLE_YPOS_HIMETRIC', 'StdPicture', 'OLE_XSIZE_HIMETRIC',
